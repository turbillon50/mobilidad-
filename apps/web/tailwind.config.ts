  ...
  theme: {
    extend: {
      colors: {
        ...
        'accent-hover': '#5A52E8',
        secondary: { DEFAULT: 'var(--color-secondary)', foreground: 'var(--color-secondary-foreground)', hover: '#00B896' },
      ...
      backgroundImage: {
        ...
        'gradient-card': 'linear-gradient(145deg, rgba(var(--color-primary-rgb),0.1), rgba(var(--color-secondary-rgb),0.05))',
        'gradient-dark': 'linear-gradient(180deg, var(--color-background) 0%, var(--color-surface) 100%)',
        'gradient-hero': 'radial-gradient(ellipse at top, rgba(var(--color-primary-rgb),0.15) 0%, transparent 60%)',
      },
      boxShadow: {
        'glow-accent': '0 0 20px rgba(var(--color-primary-rgb),0.4)',
        'glow-secondary': '0 0 20px rgba(var(--color-secondary-rgb),0.4)',
